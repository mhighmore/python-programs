...
#these set up commands that will be needed later on  
...
# 2  the introduction note that """ allows you to print multiple lines   

print("""  
The floor of the cave is now mostly submerged  
beneath inky black water. Your shoes give up the battle   
...
if hp <= 0: # you have no health points
    print("Your hero is now dead, try the game again")  
else:
    print ("You are doing well you have survived the terrible tunnel of doom!!!!  Try again soon!")
